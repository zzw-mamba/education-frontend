    ...
    <div class="card text-center py-12">
      <div v-if="isGenerating" class="mb-8">
        ...
        <p class="text-secondary-600 max-w-2xl mx-auto">
          系统正在处理您选择的{{ sourceCount }}个{{ dataSourceType === 'knowledgeBase' ? '知识库文档' : 'OCR识别文档' }}，并根据{{ selectedTemplateName }}模板生成摘要。
        </p>
...
// 选中的模板名称
const selectedTemplateName = ref(store.selectedTemplate ? store.selectedTemplate.name : '自定义')
